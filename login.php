<?php
/**
 * Módulo de Autenticación - Sistema de Auditoría SAGRAGP
 * PHP 8.x + PDO
 */
...
// Si ya hay una sesión activa, redirigir al panel principal
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare('SELECT id, username, password, nombre_completo, rol FROM usuarios WHERE username = :username LIMIT 1');
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                // Registrar variables de sesión corporativas
                ...
                <form action="login.php" method="POST">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="username" name="username" class="form-control" required autocomplete="username" placeholder="ejemplo@sagra.com" value="<?php echo htmlspecialchars($_POST['username'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
