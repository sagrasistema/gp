...
<head>
    ...
    $baseDir = preg_match('#/(ac|terminos|project|estrategia|ejecucion|conclusion|metodologia)/#i', $_SERVER['REQUEST_URI'] ?? '') ? '../main/' : '';
    ?>
    ...
    @media (max-width: 768px) {
        ...
        .meta-item:last-child {font-size: 0.95rem;  align-items: flex-start !important; text-align: left !important; margin-left: 0 !important; }
