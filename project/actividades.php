...
?>
    ...
    <!-- Formulario independiente para el control de estado (Fuera del form de actividades) -->
    <form method="POST" action="">
        <div style="margin-bottom: 1.5rem; border: 1px solid <?= $isClosed ? '#fecaca' : '#cbd5e1' ?>; border-radius: 8px; background: <?= $isClosed ? '#fef2f2' : '#ffffff' ?>; padding: 1.5rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
