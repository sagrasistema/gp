...
if ((int)$pruebaId === 11):
?>
<div style="margin-top: 3rem; border-top: 2px dashed #cbd5e1; padding-top: 2rem;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
        <h3 style="margin: 0; font-size: 1.2rem; color: #1e293b; font-weight: 700;">
            <i class="ri-bar-chart-box-line" style="color: var(--accent);"></i> Estado de Situación Financiera (Revisión Analítica)
        </h3>
        <div style="display: flex; gap: 0.5rem;">
            <button type="button" class="btn" onclick="openAnaliticaModal('activo')" style="background: #2563eb; color: #fff; padding: 0.4rem 0.8rem; font-size: 0.85rem; border-radius: 6px; border:none; cursor:pointer;">+ Activo</button>
            <button type="button" class="btn" onclick="openAnaliticaModal('pasivo')" style="background: #ea580c; color: #fff; padding: 0.4rem 0.8rem; font-size: 0.85rem; border-radius: 6px; border:none; cursor:pointer;">+ Pasivo</button>
            <button type="button" class="btn" onclick="openAnaliticaModal('patrimonio')" style="background: #16a34a; color: #fff; padding: 0.4rem 0.8rem; font-size: 0.85rem; border-radius: 6px; border:none; cursor:pointer;">+ Patrimonio</button>
        </div>
    </div>

    <!-- Tabla Financiera -->
    <div style="background: #ffffff; border: 1px solid var(--border-color); border-radius: 8px; overflow-x: auto; margin-bottom: 2rem;">
                        ...
                        ?>
                            <tr style="border-bottom: 1px solid #f1f5f9;">
                                ...
                                <td style="padding: 0.75rem; text-align: center;">
                                    <button type="submit" form="delAnalitica_<?= $item->id ?>" style="background: #fee2e2; color: #dc2626; border: none; padding: 0.25rem 0.5rem; border-radius: 4px; cursor: pointer;"><i class="ri-delete-bin-line"></i></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                        <!-- Subtotal de sección -->
