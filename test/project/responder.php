...
<div class="view-container">
    ...
    <style>
        ...
        .stage-btn { flex: 1; min-width: 180px; padding: 14px 20px; background-color: #1e3a5f; border: 1px solid #2b4c7e; border-radius: 8px; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 13px; letter-spacing: 0.5px; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.25s ease-in-out; text-transform: uppercase; }
        .stage-btn i { font-size: 16px; color: #00bcd4; }
        .stage-btn:hover { background-color: #2b4c7e; border-color: #00bcd4; transform: translateY(-2px); }
        .stage-btn.active { background-color: #0f1c2e; border: 2px solid #00bcd4; color: #ffffff; box-shadow: 0 4px 15px rgba(0, 188, 212, 0.25); }
                ...
                <div class="accordion-content" style="display: none; background: #fff;">
                    ...
                    ?>
                        <div class="prueba-row-container">
                            <!-- Título de Prueba prefijado con Número (ej. "1. Identificar y valorar...") -->
