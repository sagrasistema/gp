...
<div class="view-container">
    ...
    <div class="table-actions-container">
        ...
        <?php if ($permisosModulo1['puede_crear'] == 1) {?>
                ...
                try {
                    ...
                    if (!empty($proyectos)) {
                        foreach ($proyectos as $proj) {
                            ...
                            echo "<a href='proyecto_equipo.php?proyectoId={$proj->proyectoId}' class='btn btn-secondary' style='padding: 0.4rem 0.6rem; font-size: 0.8rem; background-color: rgba(0, 188, 212, 0.1); color: var(--accent-cian, #00bcd4); border: 1px solid var(--accent-cian, #00bcd4);' data-tooltip='Asignar Equipo'>";
                            echo "<i class='ri-team-line'></i>";
                            echo "</a>";
                            
                            echo "<a href='balance_proyecto.php?proyectoId={$proj->proyectoId}' class='btn btn-secondary' style='padding: 0.4rem 0.6rem; font-size: 0.8rem; background-color: rgba(0, 188, 212, 0.1); color: var(--accent-cian, #00bcd4); border: 1px solid var(--accent-cian, #00bcd4);' data-tooltip='Asignar Equipo'>";
                            echo "<i class='ri-team-line'></i>";
                            echo "</a>";
