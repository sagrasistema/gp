                        ...
                        <div class="prueba-row-container">
                            ...
                            <div class="prueba-actions">
                                <div style="display: flex; align-items: center; gap: 0.2rem;">
                                    ...
                                    <span style="font-size: 0.68rem; font-weight: 700; padding: 0.1rem 0.35rem; border-radius: 3px; border: 1px solid <?= $hasCI ? '#ca8a04' : '#cbd5e1' ?>; background: <?= $hasCI ? '#fef9c3' : '#f8fafc' ?>; color: <?= $hasCI ? '#ca8a04' : '#94a3b8' ?>;" title="Debilidades de Control Interno (Amarillo)">CI</span>
                                    <span style="font-size: 0.68rem; font-weight: 700; padding: 0.1rem 0.35rem; border-radius: 3px; border: 1px solid <?= $hasCG ? '#ea580c' : '#cbd5e1' ?>; background: <?= $hasCG ? '#ffedd5' : '#f8fafc' ?>; color: <?= $hasCG ? '#ea580c' : '#94a3b8' ?>;" title="Carta de Gerencia (Naranja)">CG</span>
                                    <span style="font-size: 0.68rem; font-weight: 700; padding: 0.1rem 0.35rem; border-radius: 3px; border: 1px solid <?= $hasSC ? '#dc2626' : '#cbd5e1' ?>; background: <?= $hasSC ? '#fee2e2' : '#f8fafc' ?>; color: <?= $hasSC ? '#dc2626' : '#94a3b8' ?>;" title="Situaciones Críticas (Rojo)">SC</span>
                                    <span style="font-size: 0.68rem; font-weight: 700; padding: 0.1rem 0.35rem; border-radius: 3px; border: 1px solid <?= $hasAA ? '#2563eb' : '#cbd5e1' ?>; background: <?= $hasAA ? '#dbeafe' : '#f8fafc' ?>; color: <?= $hasAA ? '#2563eb' : '#94a3b8' ?>;" title="Asuntos de Auditoría (Azul)">AA</span>
                                </div>
