...
<div class="view-container">
    ...
    <div class="project-stages-bar">
        ...
        <a href="responder4.php?proyectoId=<?= $proyectoId ?>" class="stage-btn active">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; flex-wrap: wrap; gap: 0.5rem;">
        <h1 style="font-size: 1.15rem; font-weight: 700; color: #0f172a; margin: 0; display: flex; align-items: center; gap: 0.35rem;">
            <i class="ri-dashboard-line" style="color: var(--accent);"></i>Etapa 4 Conclusión 
        </h1>
                ...
                <div class="accordion-header" onclick="toggleAccordion(this)" style="background: #f1f5f9; padding: 0.5rem 0.75rem; font-size: 0.82rem; font-weight: 700; cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.75rem;">
                        ...
                        <div style="display: flex; align-items: center; gap: 0.2rem;" onclick="event.stopPropagation();">
                            ...
                            <span style="font-size: 0.65rem; font-weight: 700; padding: 0.1rem 0.35rem; border-radius: 3px; border: 1px solid <?= $catHasCI ? '#ca8a04' : '#cbd5e1' ?>; background: <?= $catHasCI ? '#fef9c3' : '#ffffff' ?>; color: <?= $catHasCI ? '#ca8a04' : '#94a3b8' ?>;" title="Debilidades de Control Interno en esta Categoría">CI</span>
                            <span style="font-size: 0.65rem; font-weight: 700; padding: 0.1rem 0.35rem; border-radius: 3px; border: 1px solid <?= $catHasCG ? '#ea580c' : '#cbd5e1' ?>; background: <?= $catHasCG ? '#ffedd5' : '#ffffff' ?>; color: <?= $catHasCG ? '#ea580c' : '#94a3b8' ?>;" title="Carta de Gerencia en esta Categoría">CG</span>
                            <span style="font-size: 0.65rem; font-weight: 700; padding: 0.1rem 0.35rem; border-radius: 3px; border: 1px solid <?= $catHasSC ? '#dc2626' : '#cbd5e1' ?>; background: <?= $catHasSC ? '#fee2e2' : '#ffffff' ?>; color: <?= $catHasSC ? '#dc2626' : '#94a3b8' ?>;" title="Situaciones Críticas en esta Categoría">SC</span>
                            <span style="font-size: 0.65rem; font-weight: 700; padding: 0.1rem 0.35rem; border-radius: 3px; border: 1px solid <?= $catHasAA ? '#2563eb' : '#cbd5e1' ?>; background: <?= $catHasAA ? '#dbeafe' : '#ffffff' ?>; color: <?= $catHasAA ? '#2563eb' : '#94a3b8' ?>;" title="Asuntos de Auditoría en esta Categoría">AA</span>
                        </div>
