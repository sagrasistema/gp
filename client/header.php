    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', system-ui, sans-serif; }
        body { background-color: var(--bg-primary); color: var(--text-main); padding: 2rem; display: flex; justify-content: center;
            ...
            background-image: url('mosaico.svg'); 
            background-repeat: repeat; 
         }
         /* Nueva regla para controlar la barra del logo */
        .brand-topbar {
            width: 100%;
            max-width: 1200px;
            margin-bottom: 1.5rem;
            display: flex;
            justify-content: flex-start; /* Alinea el logo a la izquierda (cambia a center si lo deseas centrado) */
        }

        .brand-logo {
            height: 60px; /* Ajusta este valor para hacer tu logo más grande o pequeño */
            width: auto;
            object-fit: contain;
        }
